...
class AboutHashes < Neo::Koan
  ...
  def test_hash_keys
    ...
    assert_equal Array, hash.keys.class # hash.keys returns an array of symbols
  end
  ...
  def test_default_value
    ...
    hash2 = Hash.new("dos") # every default value will be "dos" instead of nil
    hash2[:one] = 1
  ...
  def test_default_value_with_block
    hash = Hash.new {|hash, key| hash[key] = [] } # this ensures that values don’t have the same object id
